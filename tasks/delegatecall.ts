...
const delegate_call = async (hre)=>{
    ...
    let delegatecall_counter = await ethers.getContract('zkEVMDelegateCall');
    ...
    let tx = await delegatecall_counter.call_and_delegate_call({gasLimit: 1_000_000});
